    ...
    return  (
      <div className='m-5 '>
         {animalData && 
            ...
            <div class="relative rounded-xl">
            ...
            </div><p className='m-0 p-0'>Scientific name</p><h1 className='m-0'>{animalData.scientific_name}</h1><div className="flex justify-content-center align-items-center space-between">
              ...
              </div><h2 className="self-center font-semibold mt-5">HABITAT AND ECOLOGY</h2><div className="flex flex-wrap">
              ...
              </div><h2 className="self-center font-semibold mt-5">Description</h2><p>{animalData?.description}</p><img
